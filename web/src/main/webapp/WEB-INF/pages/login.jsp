...
<div id="wrapper">
    <div id="content">
        <div id="header" style="padding: 0 0 0 0">
            <h1><a href=""><img src="<c:url value='/images/oz-logo.png'/>" style="margin-bottom: 5px;margin-top: 5px;" width="400" height="53" alt="Wudang"></a> </h1>
        </div>
            ...
            <fieldset class="form">
                ...
                <div style="float: left;margin: 8px 0 8px 70px">
                    <button type="submit" class="positive" onClick="$('#login').submit();">
                        <img src="<c:url value='/images/key.png'/>" alt="登陆">登陆
                    </button>
                    <button type="reset" class="positive" >
                        <img src="<c:url value='/images/undo.png'/>" alt="重置">重置
                    </button>
                </div>
