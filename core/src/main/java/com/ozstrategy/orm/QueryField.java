...
public class QueryField {
    ...
    public String getPartOrHql() {
		String s = "";
		if ("LT".equals(operation)){
			s = (new StringBuilder()).append(" or ").append(property).append(" < :").append(alias).toString();
		} else if ("GT".equals(operation)) {
			s = (new StringBuilder()).append(" or ").append(property).append(" > :").append(alias).toString();
		} else if ("LE".equals(operation)) {
			s = (new StringBuilder()).append(" or ").append(property).append(" <= :").append(alias).toString();
			...
			s = (new StringBuilder()).append(" or ").append(property).append(" like :").append(alias).toString();
		} else if ("LLK".equals(operation)) {
			s = (new StringBuilder()).append(" or ").append(property).append(" like :").append(alias).toString();
		} else if ("RLK".equals(operation)) {
			s = (new StringBuilder()).append(" or ").append(property).append(" like :").append(alias).toString();
            ...
            s = (new StringBuilder()).append(" or ").append(s).append(property).append(" = :").append(alias).toString();
        }
		return s;
	}
